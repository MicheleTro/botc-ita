let characters = [
    {
        ...
        examples: "<p>Evin è il Chef e Amy è il Ravenkeeper. La Washerwoman apprende che o Evin o Amy è lo Chef.</p><p>Julian è l'Imp e Alex è la Virgin. La Washerwoman apprende che o Julian o Alex è la Virgin.</p><p>Marianna è la Spy e Sarah è la Scarlet Woman. La Washerwoman apprende che uno di loro è il Ravenkeeper. <i>(Questo accade perché la Spy viene registrato come un Townsfolk—in questo caso, il Ravenkeeper)</i></p>",
    ...
    },
    {
        ...
        examples: "<p style='margin-top: 0;'>Benjamin è il Saint e Filip è il Baron. Il Librarian apprende che o Benjamin o Filip è il Saint.</p><p>Non ci sono Outsider in questa partita. Il Librarian apprende uno '0'.</p><p>Abdallah è il Drunk, che crede di essere il Monk, e Douglas è l'Undertaker. Il Librarian apprende che o Abdallah o Douglas è il Drunk. <i>(Questo accade perché il Librarian apprende il personaggio reale. Il Drunk è il vero personaggio di Abdallah, non il Monk.)</i></p>",
    ...
    },
    {
        ...
        examples: "<p>Amy è il Baron e Julian è il Mayor. L'Investigator apprende che o Amy o Julian è il Baron.</p><p>Angelus è la Spy e Lewis è il Poisoner. L'Investigator apprende che o Angelus o Lewis è la Spy.</p><p>Brianna è la Recluse e Marianna è l'Imp. L'Investigator apprende che o Brianna o Marianna è il Poisoner. <i>(Questo accade perché la Recluse viene registrata come un Minion—in questo caso, il Poisoner.)</i></p>",
    ...
    },
    {
        ...
        examples: "<p>Nessun giocatore malvagio è seduto accanto a un altro. Lo Chef apprende uno \"0\".</p><p>L’Imp è seduto accanto al Baron. Dall’altra parte del cerchio, il Poisoner è seduto accanto alla Scarlet Woman. Lo Chef apprende un \"2\".</p><p>Uno Scapegoat malvagio è seduto tra l’Imp e un Minion. Dall’altra parte del cerchio, due Minion sono seduti uno accanto all’altro. Lo Chef apprende un \"3\".</p><p>La Recluse è seduta tra l’Imp e il Poisoner. Lo Chef apprende un \"1\". Qui, la Recluse viene registrata come malvagio per la coppia Imp-Recluse, ma come good per la coppia Poisoner-Recluse</p>",
    ...
    },
    {
        ...
        examples: "<p>L'Empath ha come vicini due giocatori good — un Soldier e un Monk. L'Empath apprende uno \"0\".</p><p>Il giorno successivo, il Soldier viene giustiziato. Quella notte, il Monk viene ucciso dall'Imp. L'Empath ora rileva i giocatori vivi seduti accanto al Soldier e al Monk, che sono un Librarian e un Gunslinger evil. L'Empath ora apprende un \"1\".</p><p>In una notte successiva, rimangono vivi solo tre giocatori: l'Empath, l'Imp e il Baron. Indipendentemente da chi sia seduto dove, l'Empath apprende un \"2\".</p>",
    ...
    },
{
        ...
        examples: "<p>La Fortune Teller sceglie il Mayor e l'Undertaker, e apprende un \"no\".</p><p>La Fortune Teller sceglie l'Imp e l'Empath, e apprende un \"yes\".</p><p>La Fortune Teller sceglie un Imp vivo e un Imp morto, e apprende un \"yes\".</p><p>La Fortune Teller sceglie se stessa e un Saint, che è il Red Herring. La Fortune Teller apprende un \"yes\".</p>",
        howToRun: "<p>Mentre prepari la prima notte, metti il token promemoria <strong>RED HERRING</strong> della Fortune Teller accanto a qualsiasi token personaggio buono, segnando quel giocatore come Red Herring.</p><p>Ogni notte, sveglia la Fortune Teller. La Fortune Teller indica due giocatori qualsiasi. Se uno dei giocatori scelti è un Demon o il Red Herring, annuisci. Altrimenti, scuoti la testa. Rimetti a dormire la Fortune Teller.</p><p class=\"modal__callout-box\">Nelle partite più piccole, a volte è consigliato rendere la Fortune Teller il proprio Red Herring, poiché in questo modo la Fortune Teller ottiene più informazioni.</p>",
        group: "Townsfolk",
        script: "tb"
    },
    {
    ...
    },
    {
        ...
        howToRun: "<p>Ogni notte tranne la prima, sveglia il Monk. Il Monk indica qualsiasi giocatore tranne se stesso. <i>(Se il Monk indica se stesso, scuoti la testa in segno di no e invitalo a indicare un altro giocatore.)</i> Rimetti a dormire il Monk. Metti il token promemoria <strong>SAFE</strong> del Monk accanto al token personaggio del giocatore scelto.</p><p>Se il Demon attacca il giocatore contrassegnato <strong>SAFE</strong>, il giocatore rimane vivo. <i>(Non contrassegnarlo con il token promemoria <strong>DEAD</strong> del Demon né aggiungere un sudario come faresti normalmente.)</i> All’alba, dichiara che nessuno è morto durante la notte. </i>(Non dire perché.)</i></p><p>All’alba, rimuovi il token promemoria <strong>SAFE</strong>.</p><p class=\"modal__callout-box\">In altre edizioni, i Demon possono avere abilità diverse dall’uccidere. La protezione del Monk previene anche tutti gli altri effetti dannosi dell’abilità del Demon, come avvelenare o rendere malvagio il giocatore protetto.</p>",
        group: "Townsfolk",
        script: "tb"
    },
    {
        ...
        examples: "<p>Il Ravenkeeper viene ucciso dall'Imp, poi si sveglia per scegliere un giocatore. Dopo qualche esitazione, sceglie Ben. Ben è l'Empath e il Ravenkeeper apprende questa informazione.</p><p>L'Imp attacca il Mayor. Il Mayor non muore, ma il Ravenkeeper muore al suo posto, a causa dell’abilità del Mayor. Il Ravenkeeper viene svegliato e sceglie Doug, che è una Recluse morta. Il Ravenkeeper apprende che Doug è la Scarlet Woman, poiché la Recluse viene registrata come un Minion.</p>",
    ...
    },
{
        ...
        examples: "<p>L’Imp attacca il Soldier. Il Soldier non muore, quindi nessuno muore quella notte.</p><p>Il Poisoner avvelena il Soldier, poi l’Imp attacca il Soldier. Il Soldier muore, perché mentre è avvelenato non ha alcuna abilità.</p><p>L’Imp attacca il Mayor. Lo Storyteller sceglie che muoia il Soldier al suo posto. Tuttavia, poiché il Soldier non può essere ucciso dal Demon, quella notte non muore nessuno.</p>",
        howToRun: "<p>Durante la notte, se il Demon attacca il Soldier, il Soldier rimane vivo. <i>(All’alba, dichiara che nessuno è morto durante la notte.)</i></p><p class=\"modal__callout-box\">In altre edizioni, i Demon possono avere abilità diverse dall’uccidere. Il Soldier è anche protetto da tutti gli altri effetti dannosi dell’abilità del Demon, come avvelenare o rendere malvagio il Soldier.</p>",
        group: "Townsfolk",
        script: "tb"
    },
{
        ...
        howToRun: "<p>Durante la notte, se il Mayor dovrebbe morire, scegli se il Mayor muore davvero oppure se il Mayor rimane vivo e muore invece un altro personaggio — metti il token promemoria <strong>DEAD</strong> del Demon accanto al token di quel personaggio invece che a quello del Mayor, e metti un sudario su quel token invece che su quello del Mayor.</p><p>All’alba, dichiara che il giocatore contrassegnato <strong>DEAD</strong> è morto durante la notte. (Non dire come è morto.)</p><p>Al tramonto, se esattamente tre giocatori sono vivi e nessun giocatore è stato giustiziato oggi, dichiara che la partita termina e i buoni vincono.</p><p class=\"modal__callout-box\">Consigliamo di mantenere il Mayor in vita fino all’ultimo giorno, poiché è così che la partita risulta più divertente per i giocatori. In rari casi, se il gruppo è schiacciante­mente convinto molto presto che il Mayor sia davvero il Mayor, lascia che il Mayor muoia così che i malvagi abbiano una possibilità di vincere.</p>",
        group: "Townsfolk",
        script: "tb"
    },
{
    ...
    },
{
        ...
        examples: "<p>Il Drunk, che crede di essere il Soldier, viene attaccato dall’Imp. Il Drunk muore.</p><p>Il Drunk, che crede di essere l’Empath, si sveglia e apprende uno \"0\" anche se è seduto accanto a un giocatore malvagio. La notte successiva, apprende un \"1\".</p><p>Il Drunk, che crede di essere il Ravenkeeper, viene ucciso di notte. Sceglie il Saint, ma apprende che questo giocatore è il Poisoner.</p><p>La Fortune Teller viene giustiziata. Quella notte, il Drunk, che crede di essere l’Undertaker, apprende che il Drunk è morto oggi.</p>",
    ...
    },
{
        ...
        examples: "<p>Lo Slayer usa la sua abilità sulla Recluse. Lo Storyteller decide che la Recluse viene registrata come l’Imp, quindi la Recluse muore. Lo Slayer crede di aver appena ucciso l’Imp.</p><p>L’Empath, che ha come vicini la Recluse e il Monk, apprende di avere un vicino malvagio. La notte successiva, l’Empath apprende di non avere alcun vicino malvagio.</p><p>L’Investigator apprende che o la Recluse o il Saint è la Scarlet Woman.</p><p>La Recluse viene giustiziata. L’Undertaker apprende che è stato giustiziato l’Imp.</p><p>La Recluse è seduta accanto all’Imp e a un Traveller malvagio. Poiché mostrare un \"2\" allo Chef potrebbe essere troppo rivelatore, lo Storyteller fornisce allo Chef informazioni vere ma diverse — uno \"0\".</p>",
        howToRun: "<p>Ogni volta che la Recluse è bersaglio di un’abilità che rileva o influenza personaggi malvagi, scegli quale personaggio e quale allineamento la Recluse viene registrata come. <i>(Fai ciò che è appropriato, come mostrare un token personaggio malvagio, annuire, mostrare numeri con le dita o permettere il funzionamento di un’abilità che normalmente influenzerebbe solo giocatori malvagi, Minion o Demon.)</i></p>",
        group: "Outsider",
        script: "tb"
    },
{
    ...
    },
{
        ...
        examples: "<p>Durante la notte, il Poisoner avvelena lo Slayer. Il giorno successivo, lo Slayer prova a uccidere l’Imp. Non succede nulla. Lo Slayer ora non ha più alcuna abilità.</p><p>L’Empath avvelenato, che è seduto accanto a due giocatori malvagi, apprende uno \"0\". La notte successiva, non essendo più avvelenato, l’Empath apprende l’informazione corretta: un \"2\".</p><p>L’Investigator viene avvelenato. Apprende che uno di due giocatori è il Baron, anche se nessuno dei due è un Minion. <i>(Oppure potrebbe apprendere i giocatori corretti, ma il tipo di Minion sbagliato.)</i></p><p>L’Undertaker viene avvelenato. Anche se l’Imp è morto oggi, apprende che è morta la Virgin. Alcuni giorni dopo, un Saint avvelenato viene giustiziato e muore, e la partita continua.</p><p>Il Poisoner avvelena il Mayor, poi diventa l’Imp. Il Mayor non è più avvelenato perché non c’è più alcun Poisoner in gioco.</p>",
    ...
    },
{
        ...
        examples: "<p>La Washerwoman apprende che o Abdallah o Doug è il Ravenkeeper. Abdallah è il Monk e Doug è la Spy che viene registrata come Ravenkeeper.</p><p>La Spy è seduta accanto all’Imp e all’Empath. Lo Chef apprende un \"1\" perché la Spy viene registrata come malvagia. Più tardi quella notte, l’Empath apprende uno \"0\" perché la Spy ora viene registrata come buona.</p><p>La Spy nomina la Virgin e viene giustiziata dall’abilità della Virgin, perché lo Storyteller sceglie che la Spy venga registrata come un Townsfolk. Quella notte, l’Undertaker apprende che oggi è morto il Drunk, perché la Spy ora viene registrata come il Drunk.</p>",
    ...
    },
{
        ...
        examples: "<p>La partita viene preparata per sette giocatori, con cinque Townsfolk, un Minion e un Demon. Poiché il Minion è il Baron, lo Storyteller rimuove due token Townsfolk e aggiunge un token Saint e un token Butler. In totale, nel sacchetto finiscono token per tre Townsfolk, due Outsider, un Minion e un Demon, da far pescare ai giocatori.</p><p>La partita viene preparata per quindici giocatori, con nove Townsfolk, due Outsider, tre Minion e un Demon. Poiché il Baron è in gioco, lo Storyteller deve aggiungere un Drunk e una Recluse. Quindi rimuove il token del Monk e aggiunge un token della Recluse. Poi, invece di aggiungere il token personaggio del Drunk, aggiunge al Grimorio il token promemoria \"Is the Drunk\" del Drunk… perché in questa partita un giocatore non è un Townsfolk — è un Outsider: il Drunk. Tutti questi token personaggio finiscono nel sacchetto da cui i giocatori pescano.</p>",
    ...
    },
{
        ...
        examples: "<p>È la prima notte. L’Imp apprende che Evin e Sarah sono i Minion. L’Imp apprende anche che il Monk, lo Chef e il Librarian non sono in gioco. L’Imp bluffa come Chef, poi più avanti nella partita bluffa come Mayor. Alla fine, l’Imp viene giustiziato e i buoni vincono.</p><p>Durante la notte, l’Imp si sveglia e sceglie un giocatore, che muore. La notte successiva, l’Imp sceglie se stesso per morire. L’Imp muore e il Poisoner diventa l’Imp.</p>",
    ...
    },
    {
        ...
        examples: `<p>During the first night the Wraith peeks at other players, and notices which good players wake and which do not. During the second night, the Wraith opens their eyes more fully and notices that Doug was woken and pointed to two players tonight. During the 3rd night, when both the Wraith and the Demon wake together, the Wraith uses body language and points to the character sheet to communicate to the Demon to kill Doug, whom the Wraith believes is the Fortune Teller.</p>`,
        howToRun: `<p>Each time you wake an evil player at night, first wake the Wraith. When you put that evil player to sleep, put the Wraith to sleep.</p><p>If the Wraith loses their ability while alive, privately tell the Wraith that they may not choose to open their eyes tonight, and do not wake them when other evil players wake.</p><p class="modal__callout-box">Optional rule: Once per game, a player that is mad that you are the Wraith, dies.</p>`,
        group: "Minion",
        script: "exp"
    },
    {
...
let jinxes = [
    ...
    },
    {
        character1: "Wraith",
        character2: "Alchemist",
        rule: "If the Alchemist has the Wraith ability, they do not, and a Wraith is in play. Each day, after the execution phase, the living Alchemist may publicly guess a living player as the Wraith: if correct, the Demon must choose the Wraith tonight."
    },
    {
        character1: "Wraith",
        character2: "Magician",
        rule: "Each day, after the execution phase, the living Magician may publicly guess a living player as the Wraith: if correct, the Demon must choose the Wraith tonight."
    },
    {
        character1: "Wraith",
        character2: "Plague Doctor",
        rule: "If the Plague Doctor dies, a living Minion gains the Wraith ability in addition to their own ability, and learns this."
    },
    {
        character1: "Wraith",
        character2: "Marionette",
        rule: "The Wraith does not wake with the Marionette."
    },
];
